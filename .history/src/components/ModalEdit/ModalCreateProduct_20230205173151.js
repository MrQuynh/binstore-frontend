...
function ModalCreateProduct({ setIsModal, id, action, dataProduct, setProductEdit }) {
    console.log('data', dataProduct);

    const [contentMarkdown, setContentMarkdown] = useState(dataProduct && dataProduct.contentMarkdown === null && '');
    const [contentHTML, setContentHTML] = useState(dataProduct && dataProduct.contentHTML === null && '');
    ...
    const [count, setCount] = useState(dataProduct && dataProduct.count);
