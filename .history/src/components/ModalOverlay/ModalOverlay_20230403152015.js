...
const Login = ({ setLogin }) => {
    ...
    useEffect(() => {
        ...
        window.google.accounts.id.initialize({
            client_id: '578863112032-ch7dj2b7uo3qb9anmejcfpgkkfolrnrp.apps.googleusercontent.com',
            callback: handleCallBackResponse,
        });
        window.google.accounts.id.renderButton(document.getElementById('login_google'), {
            theme: 'outline',
            size: 'large',
        });
    }, []);
    const handleLoginGoogle = () => {
        // console.log('hello');
        // window.google.accounts.id.initialize({
        //     client_it: '274030998956-76b7mbmntuh9m4tvevjbkirsueuuqjti.apps.googleusercontent.com',
        //     callback: handleCallBackResponse,
        // });
        // window.google.accounts.id.renderButton(document.getElementById('login_google'), {
        //     theme: 'outline',
                ...
                {register ? (
                    <div className={cx('content')}>
                        ...
                        <div className={cx(homeHiden && 'home-hiden')}>
                            ...
                            <Link to="#">
                                <div id="login_google" className={cx('channel-item')} onClick={handleLoginGoogle}>
