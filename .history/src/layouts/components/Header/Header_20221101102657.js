            ...
            <div className={cx('inner')}>
                ...
                <div className={cx('actions')}>
                    ...
                    <Menu items={item} onChange={handleMenuChange}>
                        <Image
                            src="http://scontents.fdad3-4.fna.fbcdn.net/v/t39.30808-6/279841216_1091212664941555_4727043539452060717_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=tQKXwgMdAz8AX_WQ2SW&tn=4FbcTDk_s_uM-n-m&_nc_ht=scontent.fdad3-4.fna&oh=00_AfDkLDaslCFeuwtCwtvB0dIUu5M9xMbnXPZoFk19UJ9Elg&oe=6365BA09"
