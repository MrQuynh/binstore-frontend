...
function Payment() {
    ...
    const product = state.productBuyRedux;
                    ...
                    <div className={cx('body')}>
                        ...
                        <div className={cx('card-info')}>
                            <div className={cx('info-image-body')}>
                                <Image className={cx('info-image')} src={product && product.image} />
                            </div>
                            <div className={cx('info-body')}>
                                <div className={cx('info-name')}>{product && product.name}</div>
                                <div className={cx('info-price')}>
                                    Giá sản phẩm{' '}
                                    <p>
                                        <FormatPrice price={product && product.priceDown} />
                                    </p>
                                </div>
