    ...
    useEffect(() => {
        getAProductService(idProduct).then((data) => {
            if (data && data.errCode === 0) {
                ...
                dispatch(actions.setProductBuyRedux(data.data));
            }
        });
        ...
        <div className={cx('wrapper')}>
            ...
            <div className={cx('container')}>
                            ...
                            <div className={cx('product')}>
                                ...
                                <div className={cx('product-info')}>
                                    <div className={cx('more-info')}>
                                        ...
                                        <a href="#thong-so" className={cx('more-info-detail')}>
                                            Xem chi tiết thông tin thông số
                                        </a>
                                    </div>
                ...
                <div className={cx('body-markdown', seeMore && 'body-markdown-full')}>
                    ...
                    {/* </div> */}
                    <div id="thong-so" className={cx('mark-right')}>
                        <p>
