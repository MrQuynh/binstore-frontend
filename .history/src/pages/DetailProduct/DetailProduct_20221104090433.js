        ...
        <div className={cx('wrapper')}>
            <div className={cx('container')}>
                ...
                <div className={cx('question')}>
                    <div className={cx('question-title')}>Câu hỏi thường gặp</div>
                        ...
                        <div className={cx('question-item')}>
                            <div className={cx('question-item-left')}>
                                ...
                                <div className={cx('question-more-info')}>
                                    iPhone 13 Pro Max được trang bị viên pin dung lượng 4.352 mAh – mức cao chưa từng có
                                    mà một chiếc iPhone từng sở hữu. Đây là cải tiến vượt bậc mà chiếc điện thoại đem
                                    lại so với các thế hệ tiền nhiệm, hứa hẹn thời lượng sử dụng vượt trội so với mọi
                                    phiên bản còn lại thuộc iPhone 13 series.
                                </div>
                            </div>
                            <div className={cx('question-item-right')}>
