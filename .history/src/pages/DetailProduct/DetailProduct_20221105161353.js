...
function DetailProduct() {
    ...
    useEffect(() => {
        getAProductService(idProduct).then((data) => data && data.errCode === 0 && setInfoProduct(data));
    }, []);
    ...
    return (
        <div className={cx('wrapper')}>
            {isModal && <ModalBuy setIsModal={setIsModal} />}
                ...
                <div className={cx('body')}>
                    ...
                    <div className={cx('body-right')}>
                        ...
                        <div className={cx('btn')}>
                            <div className={cx('btn-buy-now')} onClick={() => setIsModal(true)}>
