...
function UserLogin() {
    ...
    useEffect(() => {
        let user = JSON.parse(localStorage.getItem('USER_LOG_IN'));
        setUserInfo(user);
    }, []);
            ...
            <div className={cx('container')}>
                <div className={cx('left')}>
                    <div className={cx('info')}>
                        <Image className={cx('avatar')} src={userInfo && userInfo.image} />
                        <div className={cx('info-icon')}>
                            <div className={cx('name')}>{userInfo && userInfo.nickName}</div>
