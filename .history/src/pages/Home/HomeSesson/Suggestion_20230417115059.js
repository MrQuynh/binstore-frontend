...
function Suggestion({ data, setCurrentPage, totalPage, currentPage }) {
            ...
            <div className={cx('container')}>
                ...
                <div className={cx('s-nav-body')}>
                    ...
                    <div className={cx('s-nav-page')}>
                        <div className={cx('s-nav-page-btn', currentPage === 1 && 'disable')} onClick>
                            Prev
                        </div>
                        <div className={cx('s-nav-page-btn', currentPage === totalPage && 'disable')}>Next</div>
                    </div>
                </div>
