...
import { Pagination, Navigation, Controller, Thumbs } from 'swiper';
        ...
        <div className={cx('wrapper')}>
            <div className={cx('box-left')}>
                <div className={cx('swiper-top')}>
                    <Swiper modules={[Controller, Thumbs]} thumbs={{ swiper: thumbsSwiper }} className="mySwiper">
            ...
            <div className={cx('box-right')}>
                <Swiper modules={[Controller, Thumbs]} thumbs={{ swiper: thumbsSwiper }}>
                    <SwiperSlide>Slide 1</SwiperSlide>
                    <SwiperSlide>Slide 2</SwiperSlide>
                    <SwiperSlide>Slide 3</SwiperSlide>
                    <SwiperSlide>Slide 4</SwiperSlide>
                </Swiper>
                <Swiper modules={[Controller, Thumbs]} onSwiper={setThumbsSwiper}>
                    <SwiperSlide>Slide 1</SwiperSlide>
                    <SwiperSlide>Slide 2</SwiperSlide>
                    <SwiperSlide>Slide 3</SwiperSlide>
                    <SwiperSlide>Slide 4</SwiperSlide>
