    ...
    return (
        <div className={cx('wrapper')}>
            ...
            <div className={cx('box-right')}>
                <Image src="https://images.fpt.shop/unsafe/fit-in/385x100/filters:quality(90):fill(white)/fptshop.com.vn/Uploads/Originals/2022/11/1/638028644329194212_F_H2_385x100.jpg" />
                <Image src="https://images.fpt.shop/unsafe/fit-in/385x100/filters:quality(90):fill(white)/fptshop.com.vn/Uploads/Originals/2022/11/1/638029092788906826_H2_.png" />
            </div>
        </div>
    );
}
