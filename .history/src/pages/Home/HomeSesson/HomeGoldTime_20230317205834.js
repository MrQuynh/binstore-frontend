...
function HomeGoldTime() {
    ...
    const config = {
        slidesPerView: +widthScreen < +840 ? (+widthScreen < +540 ? 2 : 3) : 4,
        loop: true,
        autoplay: {
            delay: 3000,
        ...
        <div className={cx('wrapper')}>
            <div className={cx('container')}>
                <div className={cx('flash')}>
                    <h2>
                        <FormattedMessage id="home.goldTime" />
                    </h2>
                    <span>
                        <FormattedMessage id="home.seeDetail" /> <GrCaretNext className={cx('flash-icon')} />
                    </span>
                </div>
                <div className={cx('flash-date')}>
                    <div className={cx('flash-date-item')}>
                        ...
                        <div className={cx('flash-sale-date-text')}>
                            <FormattedMessage id="home.finish" />
                        </div>
                    </div>
                    <div className={cx('flash-date-item')}>
                        <div className={cx('flash-sale-date')}>
                    ...
                    <div className={cx('flash-date-item', 'flash-date-active')}>
                        ...
                        <div className={cx('flash-sale-date-text')}>
                            {+14 < +d.getHours() && +d.getHours() < +17 ? (
                                <FormattedMessage id="home.happenings" />
                            ) : (
                                <FormattedMessage id="home.finish" />
                            )}
                        </div>
