            ...
            <div className={cx('container')}>
                ...
                <div className={cx('item')}>
                    <div className={cx('body-image')}>
                        <Image
                            className={cx('image')}
                            src="https://images.fpt.shop/unsafe/fit-in/60x60/filters:quality(90):fill(transparent)/fptshoom.vn/Uploads/images/2022/iconcate/icon-smart.png"
                        />
                    </div>
                ...
                <div className={cx('item')}>
                    <div className={cx('body-image')}>
                        <Image
                            className={cx('image')}
                            src="https://images.fpt.shop/unsafe/fit-in/60x60/filters:quality(90):fill(transparent)/fptshon/Uploads/images/2022/iconcate/icon-houseware.png"
                        />
                    </div>
                ...
                <div className={cx('item')}>
                    <div className={cx('body-image')}>
                        <Image
                            className={cx('image')}
                            src="https://images.fpt.shop/unsafe/fit-in/60x60/filters:quality(90):fill(transparent)/fptshocom.vn/Uploads/images/2015/Other/icon-samsung.png"
                        />
                    </div>
                ...
                <div className={cx('item')}>
                    <div className={cx('body-image')}>
                        <Image
                            className={cx('image')}
                            src="https://images.fpt.shop/unsafe/fit-in/60x60/filters:quality(90):fill(transparent)/fptsho/Uploads/images/2022/iconcate/icon-smartwatch.png"
                        />
                    </div>
