        ...
        <div className={cx('wrapper')}>
            <div className={cx('product')}>
                <div className={cx('product-image')}>
                    ...
                    <div className={cx('product-sale')}>Giảm src={data && data.sale}</div>
                    <div className={cx('product-pay')}>Trả góp 0%</div>
                </div>
                <div className={cx('product-info')}>
                    <h3 className={cx('product-info-title')}>src={data && data.name}</h3>
                    <div className={cx('product-info-price')}>
                        src={data && data.priceDown} VND <span>src={data && data.priceUp} VND</span>
                    </div>
