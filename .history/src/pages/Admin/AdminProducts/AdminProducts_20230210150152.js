            ...
            <div className={cx('container')}>
                ...
                <div className={cx('btn-body')}>
                    ...
                    <div className={cx('pagination')}>
                        {currentPage === 1 ? '' : <span className={cx('active')}>First</span>}
                        <span onClick={(e) => console.log(e.target.innerText)}>1</span>
                        <span onClick={(e) => console.log(e.target.innerText)}>2</span>
                        <span onClick={(e) => console.log(e.target.innerText)}>3</span>
                        <span>...</span>
                        <span>Last</span>
                    </div>
                </div>
