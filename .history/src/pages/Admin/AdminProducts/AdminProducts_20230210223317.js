    ...
    const handleActivePage = (item) => {
        if (currentProducts.length !== products.length) {
            ...
            if (currentPage === 3 || currentPage === 2) {
                +item.title < currentPage ? setActivePage(0) : setActivePage(1);
                currentPage > 0 && +item.title < +currentPage
            ...
            <div className={cx('container')}>
                ...
                <div className={cx('btn-body')}>
                    ...
                    <div className={cx('pagination')}>
                        {activePage === 0 ? '' : <span onClick={handleFirst}>First</span>}
