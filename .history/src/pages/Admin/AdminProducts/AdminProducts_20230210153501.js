...
function AdminProducts() {
    ...
    const handleActivePage = (item) => {
        ...
        if (item.id === 0) {
            ...
            setCurrentPage(1);
            listPage = [
                { id: 0, title: currentPage - 1 },
                { id: 1, title: currentPage },
                { id: 2, title: currentPage + 1 },
                { id: 3, title: '...' },
                { id: 4, title: 'Last' },
            ];
        }
            ...
            <div className={cx('container')}>
                ...
                <div className={cx('btn-body')}>
                    ...
                    <div className={cx('pagination')}>
                        {currentPage === 0 ? '' : <span className={cx('active')}>First</span>}
                        {listPage.map((item, index) => (
                            <span
                                className={cx(currentPage === index && 'active')}
